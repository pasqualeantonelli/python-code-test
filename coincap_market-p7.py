...
start = 1
f = 1
crypto_workbook = xlsxwriter.Workbook('crytocurrencies.xlsx')
...
crypto_sheet.write('H1', 'Work Change')

#Call the API ten times to get the thousand results; pagination
...
for i in range(10):
    ...
    for currency in data:
        ...
        # Now right all of these values to our crypto sheet
